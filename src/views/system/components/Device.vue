<template>
	...
	<el-dialog class="add-form" :title="$t('map.menuDeviceAdd')" width="50%" :visible="this.$store.state.user.visibles.deviceAddForm" :before-close="handleClose" :lock-scroll="false">
		<el-form label-width="120px" :model="addForm" ref="addForm">
			<el-row :gutter="20">
				...
				<el-col :span="12">
					<GroupTree @handleNodeClick="handleNodeClick" :userId="addForm.userId" :currentKey="currentKey"></GroupTree>
				</el-col>
	 		</el-row>
		</el-form>
	...
	<el-dialog class="edit-form"  :title="$t('map.menuDeviceEdit')" width="50%"  :visible.sync="$store.state.user.visibles.deviceEditForm" :lock-scroll="false">
		<el-form label-width="120px" :model="editForm"  ref="editForm" >
			<el-row :gutter="20">
				<el-col :span="12">
					...
					<el-form-item :label="$t('common.deviceType')" prop="typeId" label-width="170px" size="small">
						<el-select v-model="editForm.typeId"  :placeholder="$t('system.deviceType')">
							<el-option
								v-for="item in this.types"
								:key="item.id"
								:label="item.name"
				...
				<el-col :span="12">
					<GroupTree @handleNodeClick="handleNodeClick" :userId="editForm.userId" :currentKey="currentKey"></GroupTree>
				</el-col>
	 		</el-row>
		</el-form>
